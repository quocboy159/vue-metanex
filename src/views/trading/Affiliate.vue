<template>
    <div id="AffiliatePage">
        <div v-if="!isVip" class="bodyContent affiliatePage">
                ...
                <div class="subBanner bgSecondary flex items-center">
                    <div class="container">
                        <div class="vx-row items-center">
                            <div class="col">
                                <div class="flex boxContent h-full items-center">
        ...
        <div v-else class="affiliatePage pt-8">
                <div class="w-full">
                    <vs-tabs alignment="center">
                        ...
                        <vs-tab label="Hoa Hồng" @click="chiTietLoiNhuanHoaHong, showGobal = false, showCom = true, showqlHt = false">
                    ...
                    <div class="m-6">
                        <div class="gobal" :class="{'block': showGobal }">
                            ...
                            <div class="loading">
                                ...
                                <div class="dashboard-page dashboard-page--pc mt-4">
                                    <div class="vx-row">
                                        <div class="vx-col w-full lg:w-1/3 mb-4">
                                            <div class="boxBasic bgSecondary borderSecondary">
                                                <div class="heading flex items-center mb-3 pb-3 borderBtSecondary">
                                                    ...
                                                    <div class="vx-row">
                                                        <div class="vx-col w-2/3">
                                                            ...
                                                            <p class="text-xl font-size-18 colorPrimary m-0 value">
                                                                ...
                                                                <span class="colorGray" v-if="totalDlisMe == 3">2,000</span>
                                                                <span class="colorGray" v-if="totalDlisMe == 4">4,000</span>
                                                                <span class="colorGray" v-if="totalDlisMe == 5">6,000</span>
                                                                <span class="colorGray" v-if="totalDlisMe == 6">8,000</span>
                                                                <span class="colorGray" v-if="totalDlisMe >= 7">10,000</span>
                                                            </p>
                                                        </div>
                                                        <div class="vx-col w-1/3">
                                                            ...
                                                            <p class="text-xl font-size-18 m-0 value">
                                                                ...
                                                                <span class="colorGray" v-if="totalDlisMe == 3">3</span>
                                                                <span class="colorGray" v-if="totalDlisMe == 4">4</span>
                                                                <span class="colorGray" v-if="totalDlisMe == 5">5</span>
                                                                <span class="colorGray" v-if="totalDlisMe == 6">6</span>
                                                                <span class="colorGray" v-if="totalDlisMe >= 7">7</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="affiliateInfo bgSecondary borderSecondary">
                                                <p class="text-base font-bold white mb-3 affiliateInfo-title" style="vertical-align: middle;">
                                                    <svg id="unlink" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 15.885 15.885" class="mr-1">
                                                        <path id="Path_34840" data-name="Path 34840" d="M13.347,9.63l1.191-1.191a4.961,4.961,0,0,0,1.39-3.475,4.657,4.657,0,0,0-1.489-3.475A4.657,4.657,0,0,0,10.964,0,4.657,4.657,0,0,0,7.489,1.489L6.3,2.581a.96.96,0,0,0,0,1.39.96.96,0,0,0,1.39,0L8.879,2.78a3.063,3.063,0,0,1,4.17,0,3.08,3.08,0,0,1,.894,2.184,2.7,2.7,0,0,1-.894,2.085L11.957,8.24a.96.96,0,0,0,0,1.39.96.96,0,0,0,1.39,0Z" transform="translate(-0.043)" fill="#fa2843"></path>
                                                        <path id="Path_34841" data-name="Path 34841" d="M8.24,11.957,7.049,13.148a3.063,3.063,0,0,1-4.17,0,3.08,3.08,0,0,1-.894-2.184,2.7,2.7,0,0,1,.894-2.085L3.971,7.688a.96.96,0,0,0,0-1.39.96.96,0,0,0-1.39,0L1.489,7.489A4.657,4.657,0,0,0,0,10.964a4.657,4.657,0,0,0,1.489,3.475,4.657,4.657,0,0,0,3.475,1.489,4.657,4.657,0,0,0,3.475-1.489L9.63,13.247a.951.951,0,1,0-1.39-1.291Z" transform="translate(0 -0.043)" fill="#fa2843"></path>
                                                        <path id="Path_34842" data-name="Path 34842" d="M9.368,5.2,5.2,9.368a.96.96,0,0,0,0,1.39,1.072,1.072,0,0,0,.695.3,1.072,1.072,0,0,0,.695-.3l4.17-4.17A.983.983,0,1,0,9.368,5.2Z" transform="translate(-0.035 -0.035)" fill="#fa2843"></path>
                                                        <path id="Path_34843" data-name="Path 34843" d="M2.283,3.673a.9.9,0,0,0,.695.3.9.9,0,0,0,.695-.3.96.96,0,0,0,0-1.39L1.688.3A.96.96,0,0,0,.3.3a.96.96,0,0,0,0,1.39Z" transform="translate(0 0)" fill="#fa2843"></path>
                                                        <path id="Path_34844" data-name="Path 34844" d="M13.688,12.3a.983.983,0,1,0-1.39,1.39l1.986,1.986a.96.96,0,0,0,1.39,0,.96.96,0,0,0,0-1.39Z" transform="translate(-0.087 -0.087)" fill="#fa2843"></path>
                                                    </svg>
                                                ...
                                                <div class="groupButton flex mb-4 relative">
                                                    <div class="leftControl">
                                                        <input type="text" readonly="readonly" v-model="linkDk" class="form-control w-full text-base pl-2">
                                                    </div>
                                                    <div class="rightControl">
                                                        <button class="btn button primary cursor-pointer" v-clipboard:copy="linkDk" @click="saoChep">Sao chép</button>
                                                    </div>
                                                ...
                                                <div class="groupButton flex mb-3">
                                                    <div class="leftControl">
                                                        <input type="text" readonly="readonly" v-model="codeGioiThieu" class="form-control w-full text-base pl-2">
                                                    </div>
                                                    <div class="rightControl">
                                                        <button class="btn button primary cursor-pointer" v-clipboard:copy="codeGioiThieu" @click="saoChep">Sao chép</button>
                                                    </div>
                                                        ...
                                                        <div class="content">
                                                            <div class="vx-row">
                                                                <div class="vx-col w-full lg:w-1/3">
                                                                    <p class="text-xl font-bold white my-4 recent-statistics-title">Số liệu gần đây</p>
                                                                    <p class="totalReferral colorSuccess mb-4">Tổng số nhà giao dịch mới ({{ tslgdmtn }})</p>
                                                                    <p class="totalAgency colorBlue mb-4">Tổng số đại lý mới ({{ tsdlmtn }})</p>
                                                                    <p class="colorDanger">Tổng số hoa hồng mới ({{ tshhmtn }})</p>
                                                                </div>
                                                    ...
                                                    <div class="tt" :class="{'show': showTT, 'hidden': !showTT}">
                                                        <div class="content">
                                                            <div class="vx-row">
                                                                <div class="vx-col w-full lg:w-1/3">
                                                                    <p class="text-xl font-bold white my-4 recent-statistics-title">Số liệu gần đây</p>
                                                                    <p class="totalReferral colorSuccess mb-4">Tổng số nhà giao dịch mới ({{ tslgdmtt }})</p>
                                                                    <p class="totalAgency colorBlue mb-4">Tổng số đại lý mới ({{ tsdlmtt }})</p>
                                                                    <p class="colorDanger">Tổng số hoa hồng mới ({{ tshhmtt }})</p>
                                                                </div>
                                                                <div class="vx-col w-full lg:w-2/3">
                                                                    <div class="wrap-chart bgPrimary">
                                            ...
                                            <div class="networkVolumeStats bgSecondary borderSecondary">
                                                <div class="cardHeader flex items-center">
                                                    <svg id="b-chart" xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 20" class="mr-2">
                                                        <rect id="Rectangle_4604" data-name="Rectangle 4604" width="24" height="2" transform="translate(0 18)" fill="#fa2843"></rect>
                                                        <path id="Path_34533" data-name="Path 34533" d="M4,18H6a1,1,0,0,0,1-1V8A1,1,0,0,0,6,7H4A1,1,0,0,0,3,8v9A1,1,0,0,0,4,18Z" transform="translate(0 -2)" fill="#fa2843"></path>
                                                        <path id="Path_34534" data-name="Path 34534" d="M11,18h2a1,1,0,0,0,1-1V3a1,1,0,0,0-1-1H11a1,1,0,0,0-1,1V17A1,1,0,0,0,11,18Z" transform="translate(0 -2)" fill="#fa2843"></path>
                                                        <path id="Path_34535" data-name="Path 34535" d="M17,12v5a1,1,0,0,0,1,1h2a1,1,0,0,0,1-1V12a1,1,0,0,0-1-1H18A1,1,0,0,0,17,12Z" transform="translate(0 -2)" fill="#fa2843"></path>
                                                    </svg>
                                                    ...
                                                    <vs-dropdown vs-custom-content vs-trigger-click>
                                                        ...
                                                        <vs-dropdown-menu class="dropdown-question">
                                                            <p class="m-0 text-sm">Tổng khối lượng giao dịch của 7 tầng mỗi tháng.</p>
                                                        </vs-dropdown-menu>
                                                    </vs-dropdown>
                                                </div>
                                                <div class="cardBody">
                                                    ...
                                                    <div class="dataContent">
                                                        <div class="vx-row border-bottom" style="margin-left: -5px; margin-right: -5px; width: 360px;">
                                                            <div class="vx-col lg:w-5/12">
                                                        ...
                                                        <div class="vx-row" style="margin-left: -5px; margin-right: -5px; width: 360px;">
                                                            <div class="vx-col lg:w-5/12">
                                                ...
                                                <div class="cardFooter">
                                                    <div class="vx-row">
                                                        ...
                                                        <div class="vx-col lg:w-7/12">
                                                            <p class="m-0"><b>${{ formatPrice((klgdtc1 + klgdtc2 + klgdtc3 + klgdtc4) , 2)  }}</b>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="cardHeader flex items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="22.678" height="22.678" viewBox="0 0 22.678 22.678" class="mr-2">
                                                        <g id="headphones-mic" transform="translate(0.5 0.5)">
                                                            <path id="Path_29605" data-name="Path 29605" d="M1.5,9.826V6.014A5.515,5.515,0,0,1,7.014.5h6.893a5.515,5.515,0,0,1,5.514,5.514V9.826" transform="translate(0.379)" fill="none" stroke="#fa2843" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"></path>
                                                            <path id="Path_29606" data-name="Path 29606" d="M6.014,14.771H4.636A4.135,4.135,0,0,1,.5,10.636h0A4.135,4.135,0,0,1,4.636,6.5H6.014Z" transform="translate(0 2.271)" fill="none" stroke="#fa2843" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"></path>
                                                            <path id="Path_29607" data-name="Path 29607" d="M11.5,14.771h1.379a4.135,4.135,0,0,0,4.136-4.136h0A4.135,4.135,0,0,0,12.879,6.5H11.5Z" transform="translate(4.164 2.271)" fill="none" stroke="#fa2843" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"></path>
                                                            <path id="Path_29608" data-name="Path 29608" d="M12.15,16.636H5.257A2.756,2.756,0,0,1,2.5,13.879V12.5" transform="translate(0.757 4.543)" fill="none" stroke="#fa2843" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"></path>
                                                        </g>
                                                ...
                                                <div class="cardBody">
                                                    <div class="vx-row">
                                                        <div class="vx-col lg:w-4/12 text-center">
                                                            ...
                                                            <p class="elipText white text-base mb-2 getIntouch-sub-title">Support001</p>
                                                        </div>
                                ...
                                <div class="body vx-row">
                                    <!-- <div class="vx-col w-full lg:w-4/12 lg:mb-5 lg:pr-0">Mỗi ngày mới, bạn sẽ nhận hoa hồng giao dịch từ tuyến dưới của ngày hôm trước.
                                        <div class="wrap-chart bgSecondary boxShadowDashBoard commission-chart">
                                            <div class="header">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="19.135" height="16.02" viewBox="0 0 19.135 16.02"><g id="edit-curves" transform="translate(0 -2)"><path id="Path_29616" data-name="Path 29616" d="M5,13.9C14.346,13.9,9.673,3,19.02,3" transform="translate(-0.885 0)" fill="none" stroke="#fa2843" stroke-linecap="square" stroke-miterlimit="10" stroke-width="2"></path><path id="Path_29617" data-name="Path 29617" d="M18.135,17.02H1V3" transform="translate(0 0)" fill="none" stroke="#fa2843" stroke-linecap="square" stroke-miterlimit="10" stroke-width="2"></path></g></svg>
                                    ...
                                    <div class="vx-col w-full lg:mt-0 mt-4">
                                            ...
                                            <table class="table table-dark w-full tableComission bgSecondary" :class="{'ld-loading': isLoading}">
                                                            ...
                                                            <div class="flex items-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="14" viewBox="0 0 11 14" class="mr-2">
                                                                    <g id="single-copy-06" transform="translate(-1.278)">
                                                                        <rect id="Rectangle_4166" data-name="Rectangle 4166" width="10" height="11" transform="translate(1.778 2.5)" stroke-width="1" stroke="#fa2843" stroke-linecap="round" stroke-linejoin="round" fill="none"></rect>
                                                                        <line id="Line_1332" data-name="Line 1332" x2="6" transform="translate(3.778 0.5)" fill="none" stroke="#fa2843" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></line>
                                                                    </g>
                                                ...
                                                <tbody class="table-content" v-else>
                                                    <tr :key="indextr" v-for="(tr, indextr) in listChiTietKLGD">
                                                        <td class="colorSecondary">{{ formatDateAff2(tr.dt) }}</td>
                                                        <td class="colorSecondary">{{ formatPrice(tr.thanhtoan, 2) }}</td>
                                                        <td class="colorSecondary">{{ tr.soluongGD }}</td>
                                                        <!--<td class="colorSecondary">{{ tr.soluongGD }}</td>-->
                                                        <td class="colorSecondary">{{ formatPrice(tr.klgd, 2) }}</td>
                                                    </tr>
                                                </tbody>  
                                            </table>
                                        ...
                                        <div class="tableBackground bgSecondary trading-detail relative" v-else>
                                            <table class="table table-dark w-full tableComission bgSecondary" :class="{'ld-loading': isLoading}">
                                                <div class="loading">
                                                    <div class="loading__ring">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0
0,0,0,0,0,0  c0,0,0,0,0,0l0.1,0.1l0.1,0.1h0.2l0.5,0.4l1,0.7c0.4,0.2,0.6,0.5,1,0.7l1.1,0.6c0.8,0.4,1.4,0.9,2.1,1.2c1.4,0.7,2.9,1.5,4.4,2  c1.5,0.7,3.1,1,4.6,1.5c1.5,0.3,3.1,0.7,4.7,0.8c1.6,0.2,3.1,0.2,4.7,0.2c0.8,0,1.6-0.1,2.4-0.1l1.2-0.1l1.1-0.1  c3.1-0.4,6.1-1.3,8.9-2.4c0.8-0.3,1.4-0.6,2.1-0.9s1.3-0.7,2-1.1c1.3-0.7,2.6-1.7,3.7-2.5c0.5-0.4,1-0.9,1.6-1.3l0.8-0.6l0.2-0.2  c0,0,0.1-0.1,0.1-0.1c0.1-0.1,0,0,0,0v0.1l0.1-0.1l0.4-0.4c0.5-0.5,1-1,1.5-1.5c0.3-0.3,0.5-0.5,0.8-0.8l0.7-0.8  c0.9-1.1,1.8-2.2,2.5-3.3c0.4-0.6,0.7-1.1,1.1-1.7c0.3-0.7,0.6-1.2,0.9-1.8c2.4-4.9,3.5-9.8,3.7-14.4C87.3,49.7,86.6,45.5,85.5,42z"></path></svg>
                                                ...
                                                <tbody class="table-content" v-else>
                                                    <tr :key="indextr" v-for="(tr, indextr) in listChiTietKLVip">
                                                        <td class="colorSecondary">{{ formatDateAff2(tr.dt) }}</td>
                                                        <td class="colorSecondary">{{ formatPrice(100, 2) }}</td>
                                    ...
                                    <div class="paddingResult">
                                        <div class="mb-3 flex flex-wrap">
                                            ...
                                            <div class="ml-auto flex flex-wrap scrollRange items-center">
                                                ...
                                                <button class="btn btnTime mr-3 cursor-pointer" :class="{'button primary active': oneday}" @click="changeDateSelect(1)">Hôm qua</button>
                                                <button class="btn btnTime mr-3 cursor-pointer" :class="{'button primary active': twoday}" @click="changeDateSelect(7)">7 ngày gần nhất</button>
                                                <button class="btn btnTime mr-3 cursor-pointer" :class="{'button primary active': threeday}" @click="changeDateSelect(30)">30 ngày gần nhất</button>
                                                <button class="btn btnTime cursor-pointer" :class="{'button primary active': allday}" @click="changeDateSelect(0)">Tất cả</button>
                                            </div>
                                        </div>
                                        <div class="search-result">
                                            <div class="table-responsive table-pc relative">
                                                <table class="table w-full text-center overflow-hidden table-bordered mb-0" :class="{'ld-loading': isLoading}">
                                                    <div class="loading">
                                                        <div class="loading__ring">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve"><path d="M85.5,42c-0.2-0.8-0.5-1.7-0.8-2.5c-0.3-0.9-0.7-1.6-1-2.3c-0.3-0.7-0.6-1.3-1-1.9c0.3,0.5,0.5,1.1,0.8,1.7  c0.2,0.7,0.6,1.5,0.8,2.3s0.5,1.7,0.8,2.5c0.8,3.5,1.3,7.5,0.8,12c-0.4,4.3-1.8,9-4.2,13.4c-2.4,4.2-5.9,8.2-10.5,11.2  c-1.1,0.7-2.2,1.5-3.4,2c-0.5,0.2-1.2,0.6-1.
.1,1,4.6,1.5c1.5,0.3,3.1,0.7,4.7,0.8c1.6,0.2,3.1,0.2,4.7,0.2c0.8,0,1.6-0.1,2.4-0.1l1.2-0.1l1.1-0.1  c3.1-0.4,6.1-1.3,8.9-2.4c0.8-0.3,1.4-0.6,2.1-0.9s1.3-0.7,2-1.1c1.3-0.7,2.6-1.7,3.7-2.5c0.5-0.4,1-0.9,1.6-1.3l0.8-0.6l0.2-0.2  c0,0,0.1-0.1,0.1-0.1c0.1-0.1,0,0,0,0v0.1l0.1-0.1l0.4-0.4c0.5-0.5,1-1,1.5-1.5c0.3-0.3,0.5-0.5,0.8-0.8l0.7-0.8  c0.9-1.1,1.8-2.2,2.5-3.3c0.4-0.6,0.7-1.1,1.1-1.7c0.3-0.7,0.6-1.2,0.9-1.8c2.4-4.9,3.5-9.8,3.7-14.4C87.3,49.7,86.6,45.5,85.5,42z"></path></svg>
                                                        </div>
                                                    ...
                                                    <tbody v-else>
                                                        <tr :key="itr" v-for="(tr, itr) in datalistAgency">
                                                            <td>
                                                                <a href.prevent class="color-yellow underline">{{ tr.nick_name }}</a>
                                                            </td>
                                                            <td>{{ tr.level_vip }}</td>
                ...
                <vs-popup title="Các cấp bậc" :active.sync="popupActiveRank">
                    <img width="100%" :src="require('@/assets/images/sky/aff_rank.jpg')">
                </vs-popup>
        </div>
  </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            selectedLevel: {id: 1, label: 'Cấp 1'},
            optionsHoaHong: [
                {id: 1, label: 'Hoa hồng Giao dịch'},
                {id: 2, label: 'Hoa hồng VIP'}
            ],
            selectedHoaHong: {id: 1, label: 'Hoa hồng Giao dịch'},
    ...
    methods: {
        ...
        OkBuyVip(){
            this.loading = true
            AuthenticationService.UserBuyVip()
            .then((res) => {
                this.loading = false
        ...
        f1ForUser(){
            this.loading = true;
            AuthenticationService.getNguoiGioiThieu()
            .then((res) => {
                this.loading = false;
                if(res.data.success){
                    let d = res.data.data
        ...
        chiTietLoiNhuanHoaHong(){
                this.isLoading = true
                AuthenticationService.chiTietLoiNhuanHoaHong()
                .then((res) => {
        ...
        clickPageHH(page){
            this.isLoading = true
            AuthenticationService.chiTietLoiNhuanHoaHongPage(page)
            .then((res) => {
                this.isLoading = false
                if(res.data.success){
                    this.listChiTietKLGD = res.data.data
        ...
        clickPageHHVip(page){
            this.isLoading = true
            AuthenticationService.chiTietLoiNhuanHoaHongVipPage(page)
            .then((res) => {
                this.isLoading = false
                if(res.data.success){
        ...
        clickSearchDateTimeHoaHong(){
                ...
                AuthenticationService.getSeachListChiTietHH(obj)
                .then((res) => {
                    this.isLoading = false
                    if(res.data.success){
        ...
        searchCapBac(){
            ...
            AuthenticationService.getSeachListLvAgency(obj)
            .then((res) => {
                this.isLoading = false
                if(res.data.success){
        ...
        searchName(){
            ...
            AuthenticationService.getSeachListNameAgency(obj)
            .then((res) => {
                this.isLoading = false
                if(res.data.success){
                    this.datalistAgency = res.data.data
