              ...
              <p class="mb-4" style="text-decoration: overline;">
                ...
                <div class="vx-row">
                  ...
                  <div class="vx-col centerx mb-4 sm:w-1/2 md:w-1/4 lg:w-3/12 xl:w-3/12">
                    ...
                    <vs-input type="number" style="display: inline-block;" class="m-2 mb-4" label-placeholder="Phí rút USDT BEP20 (BSC)" v-model="settingJson.fee_w_usdt_BEP20"/>
                    <vs-input type="number" style="display: inline-block;" class="m-2 mb-4" label-placeholder="Phí rút USDT ERC 20" v-model="settingJson.fee_w_usdt_ERC20"/>
                  </div>
                </div>
          </div>
          ...
          <div class="vx-col w-full mb-base">
              <div class="vx-row">
                  <div class="vx-col centerx md:w-1/2 lg:w-6/12 xl:w-6/12">
                      <p class="mb-4">
                        <span style="text-decoration: overline;">[THIẾT LẬP GỬI THÔNG BÁO]: </span>
                      </p>
                      <!--<p class="mb-4">
                        Telegram Token:
                      </p> -->
                      ...
                      <div class="vx-row">
                          <div class="vx-col centerx md:w-1/2 lg:w-6/12 xl:w-6/12">
                              <p class="mb-4">
                                Telegram kênh NẠP / RÚT:
                              </p>
                              <div>
                                  <!--<vs-input style="display: inline-block;" v-model="settingJson.teleChatID" class="m-2 mb-4" label-placeholder="Chat ID"/>-->
                                  <vs-checkbox  :disabled="!activeNTF" v-model="settingJson.teleActiveDeposit" @change="changeActiveNotify('d',$event)">Nạp tiền</vs-checkbox>
                                    <p><i>- Ghi chú: Gửi tin khi người dùng nạp tiền</i></p>
                                  <vs-checkbox  :disabled="!activeNTF" v-model="settingJson.teleActiveWithdraw" @change="changeActiveNotify('w',$event)">Rút tiền</vs-checkbox>
                                    <p><i>- Ghi chú: Gửi tin khi người dùng rút tiền</i></p>
                              </div>
                          </div>
                          <div class="vx-col centerx md:w-1/2 lg:w-6/12 xl:w-6/12">
                              <p class="mb-4">
                                Telegram kênh ĐẶT CƯỢC:
                              </p>
                              <div>
                                  <!--<vs-input style="display: inline-block;" v-model="settingJson.teleChatIDBet" class="m-2 mb-4" label-placeholder="Chat ID"/>-->
                                  <vs-checkbox  :disabled="!activeNTB" v-model="settingJson.teleActiveBet" @change="changeActiveNotify('b',$event)">Đặt cược</vs-checkbox>
                  ...
                  <div class="vx-col centerx md:w-1/2 lg:w-3/12 xl:w-3/12">
                      <p class="mb-4">
                        <span style="text-decoration: overline;">[THIẾT LẬP BẢO TRÌ]: </span>
                      </p>
                      ...
                      <p class="mb-4">
                        <span style="text-decoration: overline;">[THIẾT LẬP MẠNG NẠP TIỀN]: </span>
                      </p>
                      ...
                      <p><b>- Mạng đang sử dụng là: {{ settingJson.default_netw_pay == 'tn' ? 'Thử nghiệm' : 'Chính thức' }}</b></p>
                      <p><i>- Ghi chú: Mạng nạp tiền mặc định BSC <br><a href="https://bscscan.com">https://bscscan.com</a></i></p>
                  </div>
                  <div class="vx-col centerx md:w-1/2 lg:w-3/12 xl:w-3/12">
                      <p class="mb-4">
                        <span style="text-decoration: overline;">[THIẾT LẬP ĐỊA CHỈ VÍ]: </span>
                      </p>
                      <vs-input style="display: inline-block;" class="m-2 mb-4" v-model="settingJson.ADDRESS_ETH_USDT" label-placeholder="Địa chỉ Ví nhận tiền"/>
                      <vs-input style="display: inline-block;" class="m-2 mb-4" v-model="settingJson.PRIVATE_KEY_ADDRESS_ETH_USDT" label-placeholder="Private KEY Ví nhận tiền ( Có thể rỗng )"/>
                      <p><i>- Ghi chú: Là địa chỉ Ví chính người chơi để nạp tiền vào <b>(Vui lòng liên kết 2 mạng BEP20 và ERC20)</b></i></p>
                      <vs-input style="display: inline-block;" class="m-2 mb-4" v-model="settingJson.ADDRESS_ETH_TRANSACTION" label-placeholder="Địa chỉ Ví gửi tiền"/>
                      <vs-input style="display: inline-block;" class="m-2 mb-4" v-model="settingJson.PRIVATE_KEY_ETH_TRANSACTION" label-placeholder="Private KEY Ví gửi tiền"/>
                      <p><i>- Ghi chú: Là địa chỉ Ví dùng để chi trả cho người chơi rút tiền <b>(Vui lòng liên kết 2 mạng BEP20 và ERC20)</b></i></p>
                  </div>
              </div>
          </div>
